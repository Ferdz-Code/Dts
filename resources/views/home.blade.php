            ...
            <div class="card elevation-2">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">In Progress Documents</h3>
              ...
              <div class="card-body">
                ...
                <div class="d-flex flex-row justify-content-end">
                  <span class="mr-2">
                    <i class="fas fa-square text-primary"></i> Received
                  </span>

                  <span class="mr-2">
                    <i class="fas fa-square text-gray"></i> Outgoing
                  </span>

                  <span>
                    <i class="fas fa-square text-red"></i> Closed
                  </span>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="card elevation-2">
              <div class="card-header">
                <h3 class="card-title">Department Completion</h3>
