            ...
            <div class="col-md-12">
              ...
              <div class="timeline">
                ...
                <div class="time-label">
                  <span class="bg-primary">10 May. 2020</span>
                </div>
                <!-- /.timeline-label -->
                ...
                <!-- timeline time label -->
                <div class="time-label">
                    <span class="bg-primary">3 Apr. 2020</span>
                  </div>
                  <!-- /.timeline-label -->
                ...
                <!-- timeline time label -->
                <div class="time-label">
                    <span class="bg-primary">10 Mar. 2020</span>
                  </div>
                  <!-- /.timeline-label -->
                  ...
                  <!-- timeline time label -->
                  <div class="time-label">
                      <span class="bg-primary">3 Feb. 2020</span>
                    </div>
                    <!-- /.timeline-label -->
