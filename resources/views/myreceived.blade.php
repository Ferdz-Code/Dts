    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <li class="breadcrumb-item"><a href="{{ route('home')}}">Dashboard</a></li>
                <li class="breadcrumb-item active">My Received Inbox</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-warning card-outline">
                ...
                <h3 class="card-title ">My Received</h3>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                            <tr>
                                ...
                                <td>12/12/2020</td>
                                <td>10:00 AM</td>
                                <td><i class="fas fa-reply text-gray"></i>
                                ...
                                <tr>
                                    ...
                                    <td>12/12/2020</td>
                                    <td>10:00 AM</td>
                                    <td><a href="{{ route('reply') }}"><i class="fas fa-reply text-gray"></i></a>
                                        <a href="" data-toggle="modal" data-target="#modal-view"><i class="far fa-eye text-gray"></i>
                                        <a href="" data-toggle="modal" data-target="#modal-edit"><i class="far fa-edit text-gray"></i>
                                        <a href="" data-toggle="modal" data-target="#modal-delete"><i class="far fa-trash-alt text-red"></i></a> 
                                    </td>
                                </tr>
                            </tr> 
                        <tbody>
    ...
    <!-- MODAL BODY-->
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-s">
                ...
                <!-- MODAL HEADER-->
                    <div class="modal-header">
                    <h4 class="modal-title"><i class="far fa-trash-alt text-black"></i>Delete Document</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="date_received"  id="date_received" placeholder="" class="form-control float-right" readonly>
                        </div>
                        </div>
                        <div class="form-group">
                        <label>Time received:</label>
                        <div class="input-group">
                            ...
                            <input type="text" name="time_received" id="time_received" placeholder="" class="form-control float-right" readonly>
                        </div>
                        </div>
