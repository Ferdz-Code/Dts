    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <li class="breadcrumb-item"><a href="{{ route('home')}}">Dashboard</a></li>
                <li class="breadcrumb-item active">My Outgoing Inbox</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="col-12">                
                ...
                <h3 class="card-title ">My Outgoing</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="date_Outgoing"  id="date_Outgoing" placeholder="11/11/2020" class="form-control float-right">
                            </div>
                            </div>
                            <div class="form-group">
                            <label>Time Outgoing:</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                <span class="input-group-text">
                                ...
                                <input type="time" name="time_Outgoing" id="time_Outgoing" placeholder="10:00 AM" class="form-control float-right">
                            </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="date_Outgoing"  id="date_Outgoing" placeholder="11/11/2020" class="form-control float-right" readonly>
                        </div>
                        </div>
                        <div class="form-group">
                        <label>Time Outgoing:</label>
                        <div class="input-group">
                            ...
                            <input type="text" name="time_Outgoing" id="time_Outgoing" placeholder="10:00 AM" class="form-control float-right" readonly>
                        </div>
                        </div>
